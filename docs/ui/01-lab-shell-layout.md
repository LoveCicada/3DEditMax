...
定稿：IDE 式停靠（`QMainWindow` + `QDockWidget`），不照搬 DX11-Study 网页。可交互位图见 [lab-shell-layout.svg](lab-shell-layout.svg)，线程关系见 [thread-and-hwnd.svg](thread-and-hwnd.svg)。UI 视觉重构需求见 [`docs/ui/design/`](design/) 与 [`docs/superpowers/specs/2026-08-25-ui-redesign-design.md`](../superpowers/specs/2026-08-25-ui-redesign-design.md)。
...
flowchart TB
  subgraph window [MainWindow]
    ...
    subgraph body [Central_and_Docks]
      ...
      center[Dx11ViewportWidget_plus_TutorialStrip]
