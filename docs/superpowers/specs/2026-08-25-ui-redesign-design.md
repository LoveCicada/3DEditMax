...
| REQ-TB-004 | 工具组空壳：选择/平移/轨道/推拉 | P2 | 空壳 | 已完成 | toolbar 第一组 |
| REQ-TB-005 | 工具组空壳：实心/选择/线框/追踪点（与已有着色能力接线可后做） | P2 | 空壳 | 已完成 | toolbar 第二组 |
| REQ-TB-006 | 工具组空壳：立方体/球/柱 | P2 | 空壳 | 已完成 | toolbar 第三组 |
| REQ-TB-007 | 工具组空壳：录制/性能分析/截图 | P2 | 空壳 | 已完成 | toolbar 右侧 |
