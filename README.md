...
第一期不做 3ds Max 式编辑器。设计见 [`docs/superpowers/specs/2026-08-16-dx11-lab-teach-design.md`](docs/superpowers/specs/2026-08-16-dx11-lab-teach-design.md)，界面示意图见 [`docs/ui/`](docs/ui/)。
